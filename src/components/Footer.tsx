      ...
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 1fr', gap: 32, marginBottom: 48 }}>
          <div>
            ...
            <a href="/signup" style={{ display: 'inline-block', fontSize: 13, color: '#0a0a0f', background: 'transparent', border: '1px solid #e4e4ed', padding: '8px 14px', borderRadius: 8, textDecoration: 'none', marginTop: 20, fontWeight: 600 }}>Sign up free</a>
          </div>
          <div>
            ...
            {[
              ...
              ['SEO Checker', '/website-seo-checker'],
              ['Free SEO Audit', '/free-seo-audit'],
              ['Robots.txt Checker', '/robots-txt-checker'],
              ['Meta Tag Checker', '/meta-tag-checker'],
              ['Canonical Checker', '/canonical-checker'],
              ['Hreflang Tester', '/hreflang-tester'],
            ].map(([l, h]) => (
              <a key={h} href={h} style={{ display: 'block', fontSize: 13, color: '#6b6b7d', textDecoration: 'none', marginBottom: 10 }}>{l}</a>
            ))}
          </div>
          <div>
            <div style={{ fontSize: 11, fontWeight: 700, color: '#0a0a0f', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 16 }}>Fix Guides</div>
            {[
              ['Sitemap Errors', '/sitemap-errors'],
              ['GSC Indexing Errors', '/gsc-errors'],
              ['Fix by Platform', '/fix-sitemap-for'],
          ...
          <div>
            ...
            {[
              ['What is an XML Sitemap', '/learn/what-is-an-xml-sitemap'],
              ['Crawled Not Indexed Fix', '/learn/crawled-currently-not-indexed'],
              ['Why Pages Not Indexed', '/learn/why-pages-not-indexed'],
              ['How to Create a Sitemap', '/learn/how-to-create-a-sitemap'],
              ['Sitemap Best Practices', '/learn/sitemap-best-practices'],
              ['Sitemap Validator', '/learn/sitemap-validator'],
            ].map(([l, h]) => (
              <a key={h} href={h} style={{ display: 'block', fontSize: 13, color: '#6b6b7d', textDecoration: 'none', marginBottom: 10 }}>{l}</a>
            ))}
          </div>
        ...
        <div style={{ borderTop: '1px solid #e4e4ed', paddingTop: 24, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
