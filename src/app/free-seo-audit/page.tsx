...
export const metadata: Metadata = {
  title: 'Free SEO Audit - Fix Sitemap Errors',
  description: 'Free AI SEO audit in 60 seconds. Find crawled but not indexed pages, verify sitemap health, and get a prioritized fix list. No email required.',
