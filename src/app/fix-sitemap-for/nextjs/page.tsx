  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px', fontFamily: 'Geist, sans-serif' }}>
      ...
      <p style={{ fontSize: 17, color: '#3d3d4f', lineHeight: 1.7, marginBottom: 32 }}>
        Build a perfect Next.js sitemap: static generation, dynamic routes, App Router sitemap.ts, and programmatic SEO at scale.
      </p>
      ...
      <p style={{ fontSize: 16, color: '#3d3d4f', lineHeight: 1.8, marginBottom: 24 }}>
        Next.js sites have specific sitemap challenges. This guide covers the most common sitemap issues
        we see when analyzing Next.js sites and exactly how to fix them.
      </p>
