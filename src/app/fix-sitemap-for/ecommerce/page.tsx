  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px', fontFamily: 'Geist, sans-serif' }}>
      ...
      <p style={{ fontSize: 17, color: '#3d3d4f', lineHeight: 1.7, marginBottom: 32 }}>
        E-commerce sitemap best practices: handling product variants, out-of-stock pages, faceted navigation, and seasonal content.
      </p>
      ...
      <p style={{ fontSize: 16, color: '#3d3d4f', lineHeight: 1.8, marginBottom: 24 }}>
        E-commerce Sites sites have specific sitemap challenges. This guide covers the most common sitemap issues
        we see when analyzing E-commerce Sites sites and exactly how to fix them.
      </p>

      <h2 style={{ fontSize: 24, fontWeight: 700, color: '#0a0a0f', marginBottom: 12, marginTop: 40 }}>Common E-commerce Sites Sitemap Issues</h2>
