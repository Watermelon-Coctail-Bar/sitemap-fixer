...
export const metadata: Metadata = {
  title: 'Fix Sitemap for Shopify - Complete Guide | SitemapFixer',
  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px', fontFamily: 'Geist, sans-serif' }}>
      ...
      <p style={{ fontSize: 17, color: '#3d3d4f', lineHeight: 1.7, marginBottom: 32 }}>
        Optimize your Shopify sitemap: manage product variants, fix duplicate URLs from collections, and improve indexing of your store pages.
      </p>
      ...
      <p style={{ fontSize: 16, color: '#3d3d4f', lineHeight: 1.8, marginBottom: 24 }}>
        Shopify sites have specific sitemap challenges. This guide covers the most common sitemap issues
        we see when analyzing Shopify sites and exactly how to fix them.
      </p>
