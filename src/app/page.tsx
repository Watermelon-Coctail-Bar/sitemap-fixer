...
function FreeTools() {
  const tools = [
    { title: 'Sitemap Finder', desc: 'Find any site\u2019s sitemap in seconds', href: '/sitemap-finder' },
    { title: 'XML Sitemap Checker', desc: 'Validate your sitemap for errors', href: '/sitemap-checker' },
    { title: 'Free SEO Audit', desc: 'AI-powered site audit in 60 seconds', href: '/free-seo-audit' },
    { title: 'Website SEO Checker', desc: 'Fix indexing and structure issues', href: '/website-seo-checker' },
    { title: 'XML Sitemap Generator', desc: 'Analyze and fix sitemap structure', href: '/xml-sitemap-generator' },
    { title: 'Robots.txt Checker', desc: 'Find accidentally blocked URLs', href: '/robots-txt-checker' },
    { title: 'Meta Tag Checker', desc: 'Audit titles, descriptions, OG tags', href: '/meta-tag-checker' },
    { title: 'Canonical Checker', desc: 'Verify canonicals across every page', href: '/canonical-checker' },
    { title: 'Hreflang Tester', desc: 'Validate international SEO setup', href: '/hreflang-tester' },
  ];
  return (
    <section style={{ maxWidth:960,margin:'0 auto',padding:'80px 24px' }}>
      <div style={{ textAlign:'center',marginBottom:48 }}>
        <h2 style={{ fontFamily:"'Instrument Serif',serif",fontSize:36,color:'var(--ink)',marginBottom:14 }}>Free SEO tools</h2>
        <p style={{ fontSize:16,color:'var(--muted)',maxWidth:520,margin:'0 auto' }}>Nine free tools for sitemap analysis, indexing diagnosis, and technical SEO audits.</p>
      </div>
      <div style={{ display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:16 }}>
        {tools.map(t=>(
          <a key={t.href} href={t.href} style={{ display:'block',textDecoration:'none',background:'white',border:'1px solid var(--border)',borderRadius:12,padding:'20px 22px',transition:'border-color 0.15s' }}>
            <div style={{ fontSize:15,fontWeight:700,color:'var(--ink)',marginBottom:6 }}>{t.title}</div>
                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                  return (
                                                                                                                                                                                                                                                                                                                                                                                                        <div style={{ minHeight:'100vh',background:'var(--paper)' }}>
                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                              <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: faqSchema }} />
                                                                                                                                                                                                                                                                                                                                                                                                                <Navbar />
                                                                                                                                                                                                                                                                                                                                                                                                                      <main>
                                                                                                                                                                                                                                                                                                                                                                                                                                {state === 'idle' && (<><Hero onSubmit={handleAnalyze} loading={false} variant="default" /><Features /><HowItWorks /><FreeTools /><Testimonials /><FAQ /><ContactCTA /><BlogSection /></>)}
