...
function BlogSection() {
  const posts = [
    { title: 'What is an XML Sitemap?', desc: 'The complete beginner guide - what sitemaps are, how they work, and why they matter for SEO.', href: '/learn/what-is-an-xml-sitemap', tag: 'Guide' },
    ...
    { title: 'Sitemap vs robots.txt', desc: 'The difference between sitemaps and robots.txt - and how they interact with each other.', href: '/learn/sitemap-vs-robots-txt', tag: 'Guide' },
