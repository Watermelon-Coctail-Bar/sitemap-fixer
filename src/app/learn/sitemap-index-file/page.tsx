...
export const metadata: Metadata = {
  title: 'Sitemap Index File: What It Is and When You Need One',
  ...
  openGraph: {
    title: 'Sitemap Index File: What It Is and When You Need One',
    description: 'A sitemap index file points to multiple individual sitemaps. Learn when you need one, how to create it, and how it differs from a regular sitemap.',
    url: 'https://sitemapfixer.com/learn/sitemap-index-file',
    type: 'article',
    images: [{
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Sitemap Index File: What It Is and When You Need One","description":"A sitemap index file points to multiple individual sitemaps. Learn when you need one, how to create it, and how it differs from a regular sitemap.","url":"https://sitemapfixer.com/learn/sitemap-index-file","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/sitemap-index-file"}}' }} />
