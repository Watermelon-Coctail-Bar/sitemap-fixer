...
export const metadata: Metadata = {
  ...
  description: "Category pages target high-volume commercial keywords. How to add content, structure headings, manage faceted navigation, and build authority.",
  alternates: { canonical: 'https://sitemapfixer.com/learn/category-page-seo' },
  openGraph: {
    title: 'Category Page SEO: Optimize for Rankings',
    description: 'Category pages target high-volume commercial keywords. How to add content, structure headings, and manage faceted navigation.',
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Category Page SEO: Optimize for Rankings","description":"Category pages target high-volume commercial keywords. How to add content, structure headings, and manage faceted navigation.","url":"https://sitemapfixer.com/learn/category-page-seo","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/category-page-seo"}}' }} />
