...
export const metadata: Metadata = {
  title: 'Image Sitemap: How to Add Images to Your XML Sitemap',
  ...
  openGraph: {
    title: 'Image Sitemap: How to Add Images to Your XML Sitemap',
    description: 'An image sitemap tells Google about images on your site that it might otherwise miss. Here is the format, when you need one, and how to create it.',
    url: 'https://sitemapfixer.com/learn/image-sitemap',
    type: 'article',
    images: [{
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Image Sitemap: How to Add Images to Your XML Sitemap","description":"An image sitemap tells Google about images on your site that it might otherwise miss. Here is the format, when you need one, and how to create it.","url":"https://sitemapfixer.com/learn/image-sitemap","author":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/image-sitemap"}}' }} />
