...
export const metadata: Metadata = {
  title: 'Title Tag SEO: Write Titles That Rank',
  ...
  openGraph: {
    title: 'Title Tag SEO: Write Titles That Rank',
    description: 'The title tag is the most important on-page SEO element. Here is the exact format that works, common mistakes to avoid, and how Google rewrites titles.',
    url: 'https://sitemapfixer.com/learn/title-tag-seo',
    type: 'article',
    images: [{
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Title Tag SEO: Write Titles That Rank","description":"The title tag is the most important on-page SEO element. Here is the exact format that works, common mistakes to avoid, and how Google rewrites titles.","url":"https://sitemapfixer.com/learn/title-tag-seo","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/title-tag-seo"}}' }} />
      ...
      <h1 style={{ fontSize: 40, fontWeight: 700, color: '#0a0a0f', marginBottom: 16, lineHeight: 1.15 }}>Title Tag SEO: Write Titles That Rank</h1>
