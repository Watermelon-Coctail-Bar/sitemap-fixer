...
export const metadata: Metadata = {
  title: 'Webflow Sitemap: How It Works and How to Submit It',
  ...
  openGraph: {
    title: 'Webflow Sitemap: How It Works and How to Submit It',
    description: 'Webflow automatically generates your sitemap. Learn where to find it, how to exclude pages, and how to submit it to Google Search Console.',
    url: 'https://sitemapfixer.com/learn/webflow-sitemap',
    type: 'article',
    images: [{
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Webflow Sitemap: How It Works and How to Submit It","description":"Webflow automatically generates your sitemap. Learn where to find it, how to exclude pages, and how to submit it to Google Search Console.","url":"https://sitemapfixer.com/learn/webflow-sitemap","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/webflow-sitemap"}}' }} />
