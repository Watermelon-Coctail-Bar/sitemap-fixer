...
export const metadata: Metadata = {
  ...
  description: "SSL certificates and HTTPS are required for competitive SEO. How SSL affects rankings, how to migrate correctly, and how to fix mixed content.",
  alternates: { canonical: 'https://sitemapfixer.com/learn/ssl-seo' },
  openGraph: {
    title: 'SSL and HTTPS SEO: Impact on Rankings',
    description: 'SSL certificates and HTTPS are required for competitive SEO in 2025. How SSL affects rankings and how to fix mixed content issues.',
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"SSL and HTTPS SEO: Impact on Rankings","description":"SSL certificates and HTTPS are required for competitive SEO in 2025. How SSL affects rankings and how to fix mixed content issues.","url":"https://sitemapfixer.com/learn/ssl-seo","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/ssl-seo"}}' }} />
      ...
      <div style={{ background: '#0a0a0f', borderRadius: 12, padding: '32px', textAlign: 'center', marginTop: 56 }}>
        ...
        <div style={{ marginTop: 48, borderTop: '1px solid #e4e4ed', paddingTop: 32 }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <li><a href="/learn/https-seo" style={{ color: '#2d5be3', textDecoration: 'none', fontSize: 14, lineHeight: 1.8 }}>HTTPS SEO: Why It Matters and How to Migrate Correctly</a></li></ul>
        </div>
    </div>
  );
}
