...
export const metadata: Metadata = {
  title: 'Canonical Tags: How to Use Them Correctly for SEO',
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Canonical Tags: How to Use Them Correctly for SEO","description":"Learn how canonical tags work, when to use them, and the most common mistakes that hurt your SEO. Complete guide with examples.","url":"https://sitemapfixer.com/learn/canonical-tags","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/canonical-tags"}}' }} />
