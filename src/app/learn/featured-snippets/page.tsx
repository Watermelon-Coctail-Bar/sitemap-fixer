...
export const metadata: Metadata = {
  ...
  description: "Featured snippets appear above organic results in a box. How Google selects them, which content formats win, and how to optimize for snippets.",
  alternates: { canonical: 'https://sitemapfixer.com/learn/featured-snippets' },
  openGraph: {
    title: 'Featured Snippets: Win Position Zero in Google',
    description: 'Featured snippets appear above organic results in a box. How Google selects them and how to optimize for snippet capture.',
