...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"WordPress Sitemap: Setup, Fix, and Submit Guide","description":"Everything about WordPress sitemaps - how to enable them with Yoast, RankMath, or built-in WordPress, fix common errors, and submit to Google Search Console.","url":"https://sitemapfixer.com/learn/wordpress-sitemap","author":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/wordpress-sitemap"}}' }} />
