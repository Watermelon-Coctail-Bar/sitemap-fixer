...
export const metadata: Metadata = {
  title: 'Noindex Tag: How to Use It and When to Avoid It',
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Noindex Tag: How to Use It and When to Avoid It","description":"Learn how the noindex tag works, when to use it, and critical mistakes to avoid. Includes how noindex interacts with your sitemap.","url":"https://sitemapfixer.com/learn/noindex-tag","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/noindex-tag"}}' }} />
