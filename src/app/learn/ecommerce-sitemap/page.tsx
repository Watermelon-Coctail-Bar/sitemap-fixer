...
export const metadata: Metadata = {
  title: 'Ecommerce Sitemap: How to Structure It for Maximum Indexing | SitemapFixer',
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      ...
      <h1 style={{ fontSize: 40, fontWeight: 700, color: '#0a0a0f', marginBottom: 16, lineHeight: 1.15 }}>Ecommerce Sitemap: How to Structure It for Maximum Indexing</h1>
