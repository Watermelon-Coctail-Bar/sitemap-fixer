...
export const metadata: Metadata = {
  title: 'Page Speed Optimization: Make Your Site Faster',
  ...
  openGraph: {
    title: 'Page Speed Optimization: Make Your Site Faster',
    description: 'Learn proven techniques to speed up your website. Images, caching, JavaScript, CSS - complete guide to page speed optimization for SEO.',
    url: 'https://sitemapfixer.com/learn/page-speed-optimization',
    type: 'article',
    images: [{
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Page Speed Optimization: Make Your Site Faster","description":"Learn proven techniques to speed up your website. Images, caching, JavaScript, CSS - complete guide to page speed optimization for SEO.","url":"https://sitemapfixer.com/learn/page-speed-optimization","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/page-speed-optimization"}}' }} />
