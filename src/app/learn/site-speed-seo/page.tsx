...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Site Speed SEO: How Speed Affects Rankings',
    description: 'Page speed is a confirmed Google ranking factor. Here is which speed metrics matter for SEO, how to measure them, and the highest-impact fixes for each.',
    url: 'https://sitemapfixer.com/learn/site-speed-seo',
    type: 'article',
    images: [{
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Site Speed SEO: How Speed Affects Rankings","description":"Page speed is a confirmed Google ranking factor. Here is which speed metrics matter for SEO, how to measure them, and the highest-impact fixes for each.","url":"https://sitemapfixer.com/learn/site-speed-seo","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/site-speed-seo"}}' }} />
