...
export const metadata: Metadata = {
  title: 'XML Sitemap Format: Complete Reference with Examples',
  ...
  openGraph: {
    title: 'XML Sitemap Format: Complete Reference with Examples',
    description: 'A complete XML sitemap format reference with required elements, optional tags, and working examples for standard sitemaps and sitemap index files.',
    url: 'https://sitemapfixer.com/learn/xml-sitemap-format',
    type: 'article',
    images: [{
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"XML Sitemap Format: Complete Reference with Examples","description":"A complete XML sitemap format reference with required elements, optional tags, and working examples for standard sitemaps and sitemap index files.","url":"https://sitemapfixer.com/learn/xml-sitemap-format","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/xml-sitemap-format"}}' }} />
