...
export const metadata: Metadata = {
  title: 'Squarespace Sitemap: How It Works and Common Fixes',
  ...
  openGraph: {
    title: 'Squarespace Sitemap: How It Works and Common Fixes',
    description: 'Squarespace generates your sitemap automatically. Learn where it is, what it includes, why pages might be missing, and how to submit it to Google.',
    url: 'https://sitemapfixer.com/learn/squarespace-sitemap',
    type: 'article',
    images: [{
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Squarespace Sitemap: How It Works and Common Fixes","description":"Squarespace generates your sitemap automatically. Learn where it is, what it includes, why pages might be missing, and how to submit it to Google.","url":"https://sitemapfixer.com/learn/squarespace-sitemap","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/squarespace-sitemap"}}' }} />
