...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Discovered Not Indexed: Why It Happens & Fixes","description":"Discovered - currently not indexed means Google knows your page exists but has not crawled it yet. Here is why this happens and exactly how to fix it.","url":"https://sitemapfixer.com/learn/discovered-currently-not-indexed","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/discovered-currently-not-indexed"}}' }} />
