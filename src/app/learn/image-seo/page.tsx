...
export const metadata: Metadata = {
  ...
  description: "Images appear in Google Image search, Discover, and regular web search. How to optimize filenames, alt text, compression, and structured data.",
  alternates: { canonical: 'https://sitemapfixer.com/learn/image-seo' },
  openGraph: {
    title: 'Image SEO: Optimize Images for Google Search',
    description: 'Images appear in Google Image search, Google Discover, and regular web search. How to optimize filenames, alt text, and compression.',
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Image SEO: Optimize Images for Google Search","description":"Images appear in Google Image search, Google Discover, and regular web search. How to optimize filenames, alt text, and compression.","url":"https://sitemapfixer.com/learn/image-seo","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/image-seo"}}' }} />
      ...
      <div style={{ background: '#0a0a0f', borderRadius: 12, padding: '32px', textAlign: 'center', marginTop: 56 }}>
        ...
        <div style={{ marginTop: 48, borderTop: '1px solid #e4e4ed', paddingTop: 32 }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <li><a href="/learn/image-sitemap" style={{ color: '#2d5be3', textDecoration: 'none', fontSize: 14, lineHeight: 1.8 }}>Image Sitemap: How to Add Images to Your XML Sitemap</a></li></ul>
        </div>
    </div>
  );
}
