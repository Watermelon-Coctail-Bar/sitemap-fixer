...
export const metadata: Metadata = {
  title: 'Framer Sitemap: How It Works and How to Submit It',
  ...
  openGraph: {
    title: 'Framer Sitemap: How It Works and How to Submit It',
    description: 'Framer automatically generates your sitemap. Here is where to find it, how to exclude pages from indexing, and how to submit it to Google Search Console.',
    url: 'https://sitemapfixer.com/learn/framer-sitemap',
    type: 'article',
    images: [{
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Framer Sitemap: How It Works and How to Submit It","description":"Framer automatically generates your sitemap. Here is where to find it, how to exclude pages from indexing, and how to submit it to Google Search Console.","url":"https://sitemapfixer.com/learn/framer-sitemap","author":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/framer-sitemap"}}' }} />
      ...
      <div style={{ background: '#0a0a0f', borderRadius: 12, padding: '32px', textAlign: 'center', marginTop: 56 }}>
        ...
        <div style={{ marginTop: 48, borderTop: '1px solid #e4e4ed', paddingTop: 32 }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <li><a href="/learn/ghost-sitemap" style={{ color: '#2d5be3', textDecoration: 'none', fontSize: 14, lineHeight: 1.8 }}>Ghost Sitemap: Where to Find It and How to Fix Problems</a></li></ul>
        </div>
    </div>
  );
}
