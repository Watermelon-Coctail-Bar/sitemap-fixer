...
export const metadata: Metadata = {
  title: 'Redirect Chains: How They Hurt SEO and How to Fix Them',
  description: "A redirect chain is when URL A redirects to B which redirects to C. This wastes crawl budget and dilutes PageRank. How to find and fix them.",
  alternates: { canonical: 'https://sitemapfixer.com/learn/redirect-chains' },
  openGraph: {
    title: 'Redirect Chains: How They Hurt SEO and How to Fix Them',
    description: 'A redirect chain is when URL A redirects to B which redirects to C. This wastes crawl budget, dilutes PageRank, and slows page load.',
    url: 'https://sitemapfixer.com/learn/redirect-chains',
    type: 'article',
    images: [{
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Redirect Chains: How They Hurt SEO and How to Fix Them","description":"A redirect chain is when URL A redirects to B which redirects to C. This wastes crawl budget, dilutes PageRank, and slows page load.","url":"https://sitemapfixer.com/learn/redirect-chains","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/redirect-chains"}}' }} />
      ...
      <div style={{ background: '#0a0a0f', borderRadius: 12, padding: '32px', textAlign: 'center', marginTop: 56 }}>
        ...
        <div style={{ marginTop: 48, borderTop: '1px solid #e4e4ed', paddingTop: 32 }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <li><a href="/learn/duplicate-content-seo" style={{ color: '#2d5be3', textDecoration: 'none', fontSize: 14, lineHeight: 1.8 }}>Duplicate Content SEO: Causes, Impact, and Fixes</a></li>
