...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'E-E-A-T SEO: Build Expertise and Trust',
    description: 'Google',
    url: 'https://sitemapfixer.com/learn/eeat-seo',
    type: 'article',
    images: [{
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"E-E-A-T SEO: Build Expertise and Trust","description":"Google","url":"https://sitemapfixer.com/learn/eeat-seo","author":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/eeat-seo"}}' }} />
