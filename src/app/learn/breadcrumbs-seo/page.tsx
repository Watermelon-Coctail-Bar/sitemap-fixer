...
export const metadata: Metadata = {
  ...
  description: "Breadcrumbs improve site structure signals, appear in search results, and help with internal linking. How to implement breadcrumbs and schema.",
  alternates: { canonical: 'https://sitemapfixer.com/learn/breadcrumbs-seo' },
  openGraph: {
    title: 'Breadcrumbs SEO: How They Help Rankings',
    description: 'Breadcrumbs improve site structure signals, appear in Google search results, and help with internal linking. How to implement them correctly.',
