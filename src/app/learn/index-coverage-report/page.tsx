...
export const metadata: Metadata = {
  title: 'Index Coverage Report in Google Search Console',
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Index Coverage Report in Google Search Console","description":"Learn how to read and fix the Index Coverage report in Google Search Console. Understand every status type and how to resolve indexing issues.","url":"https://sitemapfixer.com/learn/index-coverage-report","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/index-coverage-report"}}' }} />
