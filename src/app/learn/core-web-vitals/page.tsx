...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Core Web Vitals: LCP, INP, CLS Explained',
    description: 'Core Web Vitals are Google ranking signals. Learn what LCP, INP, and CLS mean, scores you need, and how to improve them.',
    url: 'https://sitemapfixer.com/learn/core-web-vitals',
    type: 'article',
    images: [{
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Core Web Vitals: LCP, INP, CLS Explained","description":"Core Web Vitals are Google ranking signals. Learn what LCP, INP, and CLS mean, scores you need, and how to improve them.","url":"https://sitemapfixer.com/learn/core-web-vitals","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/core-web-vitals"}}' }} />
