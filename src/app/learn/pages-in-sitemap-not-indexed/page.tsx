...
export default function Page() { return (
  <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Pages in Sitemap But Not Indexed: How to Fix","description":"Your pages are in your sitemap but Google is not indexing them. Here are the real reasons this happens and exactly how to fix each one.","url":"https://sitemapfixer.com/learn/pages-in-sitemap-not-indexed","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/pages-in-sitemap-not-indexed"}}' }} />
