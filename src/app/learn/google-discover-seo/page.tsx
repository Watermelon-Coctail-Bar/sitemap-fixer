...
export const metadata: Metadata = {
  ...
  description: "Google Discover shows content to users based on interests, not search queries. How to optimize for Discover, what content performs well, and tracking.",
  alternates: { canonical: 'https://sitemapfixer.com/learn/google-discover-seo' },
  openGraph: {
    title: 'Google Discover SEO: Get Into Discover Feed',
    description: 'Google Discover shows content to users based on their interests, not search queries. How to optimize for Discover and track results.',
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Google Discover SEO: Get Into Discover Feed","description":"Google Discover shows content to users based on their interests, not search queries. How to optimize for Discover and track results.","url":"https://sitemapfixer.com/learn/google-discover-seo","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/google-discover-seo"}}' }} />
      ...
      <div style={{ background: '#0a0a0f', borderRadius: 12, padding: '32px', textAlign: 'center', marginTop: 56 }}>
        ...
        <div style={{ marginTop: 48, borderTop: '1px solid #e4e4ed', paddingTop: 32 }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <li><a href="/learn/amp-seo" style={{ color: '#2d5be3', textDecoration: 'none', fontSize: 14, lineHeight: 1.8 }}>AMP SEO: What It Is and Whether You Still Need It</a></li></ul>
        </div>
    </div>
  );
}
