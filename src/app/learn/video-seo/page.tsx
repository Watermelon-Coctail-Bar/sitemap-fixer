...
export const metadata: Metadata = {
  ...
  description: "Video can rank in Google Search, Google Video, and YouTube. How to optimize hosted and embedded videos for search, including schema and sitemaps.",
  alternates: { canonical: 'https://sitemapfixer.com/learn/video-seo' },
  openGraph: {
    title: 'Video SEO: Get Videos to Rank in Google',
    description: 'Video can rank in Google Search, Google Video, and YouTube. How to optimize hosted and embedded videos, including video sitemaps.',
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Video SEO: Get Videos to Rank in Google","description":"Video can rank in Google Search, Google Video, and YouTube. How to optimize hosted and embedded videos, including video sitemaps.","url":"https://sitemapfixer.com/learn/video-seo","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/video-seo"}}' }} />
