...
export const metadata: Metadata = {
  ...
  description: "Local SEO gets your business in the Google Maps pack and local search results. Learn how Google Business Profile, citations, and reviews work.",
  alternates: { canonical: 'https://sitemapfixer.com/learn/local-seo' },
  openGraph: {
    title: 'Local SEO: How to Rank in Google Maps and Local Search',
    description: 'Local SEO gets your business in the Google Maps pack and local search. How Google Business Profile, citations, and reviews work together.',
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Local SEO: How to Rank in Google Maps and Local Search","description":"Local SEO gets your business in the Google Maps pack and local search. How Google Business Profile, citations, and reviews work together.","url":"https://sitemapfixer.com/learn/local-seo","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/local-seo"}}' }} />
