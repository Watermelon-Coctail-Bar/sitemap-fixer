...
export const metadata: Metadata = {
  title: 'Internal Linking for SEO: Complete Strategy Guide',
  ...
  openGraph: {
    title: 'Internal Linking for SEO: Complete Strategy Guide',
    description: 'Learn how internal links distribute PageRank, improve crawlability, and boost rankings. Complete internal linking strategy with examples.',
    url: 'https://sitemapfixer.com/learn/internal-linking',
    type: 'article',
    images: [{
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Internal Linking for SEO: Complete Strategy Guide","description":"Learn how internal links distribute PageRank, improve crawlability, and boost rankings. Complete internal linking strategy with examples.","url":"https://sitemapfixer.com/learn/internal-linking","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/internal-linking"}}' }} />
