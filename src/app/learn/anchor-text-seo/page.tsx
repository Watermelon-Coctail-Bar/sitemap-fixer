...
export const metadata: Metadata = {
  title: 'Anchor Text SEO: Types & Best Practices',
  description: "Anchor text tells Google what the linked page is about. How to use exact match, partial match, branded, and generic anchors in the right proportions.",
  alternates: { canonical: 'https://sitemapfixer.com/learn/anchor-text-seo' },
  openGraph: {
    title: 'Anchor Text SEO: Types & Best Practices',
    description: 'Anchor text tells Google what the linked page is about. How to use exact match, partial match, branded, and generic anchors correctly.',
    url: 'https://sitemapfixer.com/learn/anchor-text-seo',
    type: 'article',
    images: [{
...
export default function Page() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Anchor Text SEO: Types & Best Practices","description":"Anchor text tells Google what the linked page is about. How to use exact match, partial match, branded, and generic anchors correctly.","url":"https://sitemapfixer.com/learn/anchor-text-seo","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/learn/anchor-text-seo"}}' }} />
