    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Article', headline: 'URLs Blocked by Robots.txt in Sitemap: Fix Guide', description: 'Fix the contradictory signal of URLs blocked by robots.txt appearing in your XML sitemap. Detect disallow conflicts that prevent indexing in seconds.', url: 'https://sitemapfixer.com/sitemap-errors/blocked-by-robots-txt', author: { '@type': 'Organization', name: 'SitemapFixer', url: 'https://sitemapfixer.com' }, publisher: { '@type': 'Organization', name: 'SitemapFixer', url: 'https://sitemapfixer.com', logo: { '@type': 'ImageObject', url: 'https://sitemapfixer.com/opengraph-image' } }, datePublished: '2026-04-17', mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://sitemapfixer.com/sitemap-errors/blocked-by-robots-txt' } }),
        }}
      />
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Home', item: 'https://sitemapfixer.com/' }, { '@type': 'ListItem', position: 2, name: 'Sitemap Errors', item: 'https://sitemapfixer.com/sitemap-errors' }, { '@type': 'ListItem', position: 3, name: 'URLs Blocked by Robots.txt in Sitemap: Fix Guide', item: 'https://sitemapfixer.com/sitemap-errors/blocked-by-robots-txt' }] }),
        }}
      />
