    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Article', headline: 'UTF-8 Encoding Issues in Sitemap: Fix Guide', description: 'Fix UTF-8 encoding problems in your sitemap - BOM bytes, mojibake characters, percent-encoding errors. Broken encoding makes Googlebot reject entire sitemaps.', url: 'https://sitemapfixer.com/sitemap-errors/utf8-encoding-issues', author: { '@type': 'Organization', name: 'SitemapFixer', url: 'https://sitemapfixer.com' }, publisher: { '@type': 'Organization', name: 'SitemapFixer', url: 'https://sitemapfixer.com', logo: { '@type': 'ImageObject', url: 'https://sitemapfixer.com/opengraph-image' } }, datePublished: '2026-04-17', mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://sitemapfixer.com/sitemap-errors/utf8-encoding-issues' } }),
        }}
      />
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Home', item: 'https://sitemapfixer.com/' }, { '@type': 'ListItem', position: 2, name: 'Sitemap Errors', item: 'https://sitemapfixer.com/sitemap-errors' }, { '@type': 'ListItem', position: 3, name: 'UTF-8 Encoding Issues in Sitemap: Fix Guide', item: 'https://sitemapfixer.com/sitemap-errors/utf8-encoding-issues' }] }),
        }}
      />
