...
export const metadata: Metadata = {
  title: 'Free XML Sitemap Checker & Validator',
  description: 'Free XML sitemap checker and validator. Find broken URLs, crawled but not indexed pages, and stale content. Get AI-powered fixes.',
