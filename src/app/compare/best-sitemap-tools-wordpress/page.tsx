    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Article', headline: 'Best Sitemap Tools for WordPress (2026 Comparison)', description: 'Yoast, Rank Math, All in One SEO, SEOPress, and SitemapFixer compared. Find the right sitemap plugin - and audit tool - for your WordPress site.', url: 'https://sitemapfixer.com/compare/best-sitemap-tools-wordpress', author: { '@type': 'Organization', name: 'SitemapFixer', url: 'https://sitemapfixer.com' }, publisher: { '@type': 'Organization', name: 'SitemapFixer', url: 'https://sitemapfixer.com', logo: { '@type': 'ImageObject', url: 'https://sitemapfixer.com/opengraph-image' } }, datePublished: '2026-04-17', mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://sitemapfixer.com/compare/best-sitemap-tools-wordpress' } }),
        }}
      />
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Home', item: 'https://sitemapfixer.com/' }, { '@type': 'ListItem', position: 2, name: 'Compare', item: 'https://sitemapfixer.com/compare' }, { '@type': 'ListItem', position: 3, name: 'Best Sitemap Tools for WordPress (2026 Comparison)', item: 'https://sitemapfixer.com/compare/best-sitemap-tools-wordpress' }] }),
        }}
      />
