...
export default function Page() {
  return (
    <article style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Broken Links SEO: How They Hurt Rankings & Fixes","description":"Broken links waste crawl budget, leak PageRank, and damage user experience. Here is how to find all broken links on your site and fix them efficiently.","url":"https://sitemapfixer.com/blog/broken-links-seo","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/blog/broken-links-seo"}}' }} />April 2025 · 6 min read</div>
