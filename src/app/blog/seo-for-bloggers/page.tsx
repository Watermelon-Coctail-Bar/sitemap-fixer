...
export default function Page() {
  return (
    <article style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"SEO for Bloggers: Get Your Posts Ranked on Google","description":"Blog SEO turns your writing into organic traffic. Here is the essential SEO process for every blog post - from keyword research to optimization to promotion.","url":"https://sitemapfixer.com/blog/seo-for-bloggers","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/blog/seo-for-bloggers"}}' }} />April 2025 · 6 min read</div>
