    ...
    <article style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      ...
      <div style={{ fontSize: 16, color: '#3d3d4f', lineHeight: 1.85 }}>
        ...
        {[
          ...
          { n:'3', t:'Invalid XML / Parse Errors', d:'Even a single invalid character breaks the entire sitemap. Common causes: unescaped ampersands (use &amp; not &), smart quotes instead of straight quotes, non-UTF-8 characters, or a server error message printed before the XML declaration. Validate your sitemap at validator.w3.org or paste it into an online XML validator.' },
          { n:'4', t:'Sitemap Contains URLs That Are Blocked or Redirecting', d:'Google Search Console will report errors for any sitemap URLs that return non-200 status codes, redirect to other URLs, or are blocked by robots.txt. Clean your sitemap so it only contains canonical, final-destination URLs that return 200.' },
          ...
          { n:'6', t:'Sitemap Is Not Referenced in Robots.txt', d:'Add "Sitemap: https://yourdomain.com/sitemap.xml" to your robots.txt file. This helps search engines find your sitemap even if they have not been told about it via Search Console. It is also best practice to ensure the sitemap URL is absolute, not relative.' },
          { n:'7', t:'Sitemap Has Not Been Submitted to Google Search Console', d:'Just publishing a sitemap is not enough. Submit it explicitly in Google Search Console under Sitemaps. This triggers an immediate fetch and gives you error reports. After submission, wait 24-48 hours and check the status.' },
          { n:'8', t:'Sitemap URL Includes Incorrect Domain or Protocol', d:'All URLs in your sitemap must match your canonical domain exactly. If your site uses HTTPS, all sitemap URLs must use HTTPS. If your site uses www, all URLs must include www. Mixed protocols or domains in a sitemap cause indexing inconsistencies.' },
          { n:'9', t:'CMS Plugin Generating a Broken Sitemap', d:'In WordPress, plugins like Yoast, RankMath, and All-in-One SEO generate sitemaps automatically. Conflicts between multiple active sitemap plugins, or plugin updates introducing bugs, can break your sitemap. Deactivate all but one sitemap plugin and re-validate.' },
        ].map(({ n, t, d }) => (
      ...
      <div style={{ marginTop: 48, borderTop: '1px solid #e4e4ed', paddingTop: 32 }}>
        ...
        <ul style={{ listStyle: 'none', padding: 0, display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          ...
          <li><a href="/blog/how-to-fix-sitemap-errors" style={{ color: '#2d5be3', textDecoration: 'none', background: '#eef1ff', padding: '6px 14px', borderRadius: 6, fontSize: 13 }}>Fix Sitemap Errors</a></li>
