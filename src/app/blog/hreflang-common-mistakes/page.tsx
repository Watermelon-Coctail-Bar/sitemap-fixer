...
export default function Page() {
  return (
    <article style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Hreflang Mistakes: Fix International SEO","description":"Hreflang is one of the most error-prone SEO implementations. Here are the 7 most common hreflang mistakes and exactly how to fix each one.","url":"https://sitemapfixer.com/blog/hreflang-common-mistakes","author":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/blog/hreflang-common-mistakes"}}' }} />April 2025 · 8 min read</div>
