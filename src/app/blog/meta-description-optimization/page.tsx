...
export default function Page() {
  return (
    <article style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Meta Description Optimization: Write Click-Worthy Copy","description":"Meta descriptions are your billboard in search results. Here is how to write meta descriptions that improve click-through rates and drive more organic traffic.","url":"https://sitemapfixer.com/blog/meta-description-optimization","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/blog/meta-description-optimization"}}' }} />April 2025 · 5 min read</div>
