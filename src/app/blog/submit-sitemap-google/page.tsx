...
export default function Page() {
  return (
    <article style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"How to Submit a Sitemap to Google: Step-by-Step Guide","description":"Submitting your sitemap to Google Search Console tells Google where to find all your pages. Here is the exact process and how to verify it worked.","url":"https://sitemapfixer.com/blog/submit-sitemap-google","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/blog/submit-sitemap-google"}}' }} />April 2025 · 5 min read</div>
