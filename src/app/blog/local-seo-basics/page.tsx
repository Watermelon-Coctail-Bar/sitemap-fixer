...
export const metadata: Metadata = {
  title: 'Local SEO Basics: How to Rank in Google Local Search',
  ...
  openGraph: {
    title: 'Local SEO Basics: How to Rank in Google Local Search',
    description: 'Local SEO helps businesses appear when people search for nearby services. Here are the foundational steps to rank in Google Maps and local search results.',
    url: 'https://sitemapfixer.com/blog/local-seo-basics',
    type: 'article',
    images: [{
...
export default function Page() {
  return (
    <article style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Local SEO Basics: How to Rank in Google Local Search","description":"Local SEO helps businesses appear when people search for nearby services. Here are the foundational steps to rank in Google Maps and local search results.","url":"https://sitemapfixer.com/blog/local-seo-basics","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/blog/local-seo-basics"}}' }} />April 2025 · 7 min read</div>
