...
export const metadata: Metadata = {
  title: 'SEO Blog: Technical Guides & Tips',
  description: 'Expert guides on fixing indexing issues, XML sitemap errors, and technical SEO. Free articles from the SitemapFixer team.',
