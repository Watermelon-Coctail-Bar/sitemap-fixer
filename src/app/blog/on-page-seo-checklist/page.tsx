...
export default function Page() {
  return (
    <article style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"On-Page SEO Checklist: Optimize Before Publishing","description":"On-page SEO covers everything you control on the page itself. This checklist ensures every element is optimized before you publish any new content.","url":"https://sitemapfixer.com/blog/on-page-seo-checklist","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/blog/on-page-seo-checklist"}}' }} />April 2025 · 5 min read</div>
