...
export default function Page() {
  return (
    <article style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Crawl Budget SEO: Stop Wasting Crawls on Bad Pages","description":"Crawl budget limits how many pages Google crawls on your site. Here is how to stop wasting it on low-value pages and ensure your important content gets crawled.","url":"https://sitemapfixer.com/blog/crawl-budget-seo-guide","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/blog/crawl-budget-seo-guide"}}' }} />April 2025 · 5 min read</div>
