...
export const metadata: Metadata = {
  title: 'Anchor Text Guide: How to Use Link Anchor Text for SEO',
  description: "Anchor text tells Google what the linked page is about. How to optimize anchor text for internal and external links to maximize SEO impact.",
  alternates: { canonical: 'https://sitemapfixer.com/blog/anchor-text-guide' },
  openGraph: {
    title: 'Anchor Text Guide: How to Use Link Anchor Text for SEO',
    description: 'Anchor text tells Google what the linked page is about. How to optimize anchor text for internal and external links without penalties.',
    url: 'https://sitemapfixer.com/blog/anchor-text-guide',
    type: 'article',
    images: [{
...
export default function Page() {
  return (
    <article style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Anchor Text Guide: How to Use Link Anchor Text for SEO","description":"Anchor text tells Google what the linked page is about. How to optimize anchor text for internal and external links without penalties.","url":"https://sitemapfixer.com/blog/anchor-text-guide","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/blog/anchor-text-guide"}}' }} />April 2025 · 5 min read</div>
