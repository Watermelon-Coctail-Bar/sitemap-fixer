...
export default function Page() {
  return (
    <article style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Noindex Fix: Remove Noindex from Pages That Should Rank","description":"A noindex tag blocks Google from indexing your page. Here is how to find accidental noindex tags, why they happen, and how to fix them to restore indexing.","url":"https://sitemapfixer.com/blog/noindex-fix-guide","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/blog/noindex-fix-guide"}}' }} />April 2025 · 5 min read</div>
