...
export default function Page() {
  return (
    <article style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"XML Sitemap Submission: Submit to Google & Bing","description":"Submitting your sitemap helps Google and Bing discover and index your pages faster. Here is how to submit to Google Search Console and Bing Webmaster Tools.","url":"https://sitemapfixer.com/blog/xml-sitemap-submission","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/blog/xml-sitemap-submission"}}' }} />April 2025 · 5 min read</div>
