...
export default function Page() {
  return (
    <article style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Sitemap vs Robots.txt: How They Work Together","description":"Sitemaps and robots.txt serve opposite purposes. One tells Google what to crawl. The other tells it what not to. Here is how each works and how to use both correctly.","url":"https://sitemapfixer.com/blog/sitemap-vs-robots-txt","author":{"@type":"Person","name":"Arnoldas Arny","url":"https://sitemapfixer.com/about"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/blog/sitemap-vs-robots-txt"}}' }} />April 2025 · 7 min read</div>
