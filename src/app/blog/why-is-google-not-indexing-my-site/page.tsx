...
export default function Page() {
  return (
    <article style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Article","headline":"Why Is Google Not Indexing My Site? 11 Causes and Fixes","description":"Google not indexing your website? Here are the 11 most common reasons and exactly how to fix each one.","url":"https://sitemapfixer.com/blog/why-is-google-not-indexing-my-site","author":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com"},"publisher":{"@type":"Organization","name":"SitemapFixer","url":"https://sitemapfixer.com","logo":{"@type":"ImageObject","url":"https://sitemapfixer.com/opengraph-image"}},"datePublished":"2025-01-15","mainEntityOfPage":{"@type":"WebPage","@id":"https://sitemapfixer.com/blog/why-is-google-not-indexing-my-site"}}' }} />April 2025 · 9 min read</div>
